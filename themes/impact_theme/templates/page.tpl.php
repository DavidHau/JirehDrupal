  ...
  <div id="main" class="clearfix">
    <div id="primary">
      <section id="content" role="main">
        ...
        $slide4_url = check_plain(theme_get_setting('slide4_url','impact_theme'));
        ...
        $slide4_desc = check_markup(theme_get_setting('slide4_desc', 'impact_theme'), 'full_html'); 
        ?>
        <div id="slider">
          <div id="slider-wrap">
            ...
            <div class="slides displaynone">
              <a href="<?php print url($slide4_url); ?>"><img width="644" height="320" src="<?php print base_path() . drupal_get_path('theme', 'impact_theme') . '/images/slide-image-2.jpg'; ?>" class="pngfix"/></a>
