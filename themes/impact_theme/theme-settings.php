...
function impact_theme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['impact_theme_settings']['slideshow']['slide4'] = array(
    '#type' => 'fieldset',
    '#title' => t('Slide 4'),
  );
  $form['impact_theme_settings']['slideshow']['slide4']['slide4_desc'] = array(
    '#type' => 'textarea',
    '#title' => t('Slide Description'),
    '#default_value' => theme_get_setting('slide4_desc','impact_theme'),
  );
  $form['impact_theme_settings']['slideshow']['slide4']['slide4_url'] = array(
    '#type' => 'textfield',
    '#title' => t('Slide URL'),
    '#default_value' => theme_get_setting('slide4_url','impact_theme'),
  );
